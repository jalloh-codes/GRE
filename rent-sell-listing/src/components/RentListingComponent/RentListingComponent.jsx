...
export const RentListingComponent = () => {
    return (
        <div className="App">
            <Header />
                    ...
                    <div className="property_info">
                        <form>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="property type" className="prop_input" />
                            </div>
                            <div>
                                <label>Property monthly price</label>
                                <input type="Number" min="0" placeholder="property monthly price" className="prop_input" />
                            </div>
